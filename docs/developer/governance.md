...
| --- | --- | --- |
| `docs/reference/cli.md` | Click option definitions + `docs/reference/cli/options-manifest.yaml` + `scripts/docs/generate_cli_docs.py` | CLI contract shape, flag semantics, and generated table sync |
...
- MUST regenerate rules docs via `uv run python scripts/docs/generate_rules_docs.py`.
